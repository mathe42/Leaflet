...
// @function pointToSegmentDistance(ex: Point, p1: Point, p2: Point): Number
...
export function closestPointOnSegment(p: Point, p1: Point, p2: Point) {
...
function _reducePoints(points: Point[], sqTolerance: number) {
